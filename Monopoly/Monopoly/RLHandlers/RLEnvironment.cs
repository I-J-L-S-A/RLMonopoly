...
namespace Monopoly.RLHandlers
{
    public class RLEnvironment
    {
        ...
        {
            Trace.WriteLine("Empezando Monopoly");
            ...
            //{
                ...
                this.gamePlayers[0].agent_init('q', false, "Agent0" , (23)); //agent type(random-qlearning, policyFrozen, name, input vector length
            ...
            this.gamePlayers[1].agent_init('r', true, "Agent1", (23)); //agent type(random-qlearning, policyFrozen, name, input vector length
            ...
            this.gamePlayers[2].agent_init('r', false, "Agent2", (23)); //agent type(random-qlearning, policyFrozen, name, input vector length
            Trace.WriteLine("Anadidos agentes");
            averageMoney[2] = 0;
            ...
            {       
                System.Threading.Thread.Sleep(100);
                Trace.WriteLine("Juego numero " + currentGame);
                Awriter.WriteLine("---------------------------------");
             ...
             if ((currentGame % 2).Equals(0) && (!gamePlayers[0].getType().Equals('r')))
